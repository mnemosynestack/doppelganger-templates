...
// Use React.memo to prevent unnecessary re-renders of individual cards when the parent grid updates
// (e.g. during client-side sorting/filtering) since all props are primitives.
